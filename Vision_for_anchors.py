...
def decode(loc, priors, variances):
    # Center decodes, weight and height decode
...
class Anchors(object):
    ...
    def get_anchors(self):
        ...
        for k, f in enumerate(self.feature_maps):
            ...
            # The anchors of each grid point are square.
...
plt.ylim(-300,900)
plt.xlim(-300,900)
ax.invert_yaxis()  # The opposite direction of y axis
